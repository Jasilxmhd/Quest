...
#     return subjects
# print(display_subjects("Maths","physics",'os'))
...
# print(shopping_total(100,500,500))
...
#                 print(k ,':', v)
# student_profile(Name= 'jasil' , id = 102 , Place = 'Calicut')
...
# employee_record(Name = "Azeez" , DOB = '02-10-1980',Place = 'Karama')
...
# product_details(Product_Name = 'Apple juice' ,mfg = '04-11-26',Exp_date = '12 months')
...
# report_card("Jasil", 50,60,45 , Grade = "A grade" , Department = 'Computer Software' )
