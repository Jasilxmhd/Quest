...
'This worksheet contains practical lab questions focused on Python functions only. Topics include function definition, arguments, return values, default arguments, keyword arguments, variable-length arguments,recursion, and small real-world logic problems. Section A – Basic Function Questions'
